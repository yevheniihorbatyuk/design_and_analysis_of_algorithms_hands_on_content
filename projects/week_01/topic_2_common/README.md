...
Оберіть номер демонстрації або натисніть Enter для запуску всіх прикладів підряд.
...
```
├── greedy_algorithms.py      # Жадібні алгоритми та візуалізація
├── dynamic_programming.py    # ДП алгоритми та візуалізація  
├── graph_algorithms.py       # Графові алгоритми (Дейкстра, MST, TSP)
├── main_demo.py             # Головний демонстраційний скрипт
├── test_algorithms.py       # Комплексні юніт-тести
...
- **Юніт-тести** для всіх алгоритмів
- **Інтеграційні тести** порівняння підходів
- **Тести граничних випадків** 
- **Тести продуктивності** та масштабованості

Запуск: `python test_algorithms.py`
...
1. **Перевірте тести:** `python test_algorithms.py`
2. **Подивіться логи** в консолі демонстрацій  
3. **Перевірте залежності:** `pip install -r requirements.txt`
4. **Оновіть Python** до версії 3.8+
